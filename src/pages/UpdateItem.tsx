...
class UpdateItem extends React.Component<any, any> {
    ...
    getItemWithId(this.state.id)
        .then(function (res) {
          _this.setState( {
            ...
            set: res.data.setName,
            location: res.data.location.serial,
            locationId: res.data.location.id,
            returnTime: res.data.borrowTermEnum,
    ...
    return (
        <IonPage>
          <IonContent fullscreen>
            ...
            <IonButton strong expand="block" onClick={() => this.updateItems()}>Update</IonButton>
          </IonContent>
        </IonPage>
    );
  };
